...
def select_market_scenario(seed=None):
    ...
    # Market scenario probabilities (like z17)
    scenarios = {
...
def calculate_straddle_volatility_by_dte(enhanced_results):
    """
    Calculate straddle price volatility by days to expiry across all groups
    """
    
    print(f"\nCalculating straddle volatility by DTE...")
    
    # Collect all straddle values by DTE across all groups and simulations
    dte_volatility_data = {}
...
def main():
    """
    Main function to run the realistic random walk analysis
    """
    ...
    # Step 4: Calculate straddle volatility analysis
    volatility_df = calculate_straddle_volatility_by_dte(enhanced_results)
